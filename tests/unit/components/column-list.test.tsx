...
describe("ColumnList", () => {
  ...
  test("renders all column names", () => {
    const html = renderToStaticMarkup(<ColumnList columns={[primaryColumn, regularColumn]} indexes={[]} />);
  ...
  test("displays simple type as-is", () => {
    const html = renderToStaticMarkup(<ColumnList columns={[nullableColumn]} indexes={[]} />);
  ...
  test("renders indexes section when indexes exist", () => {
    const html = renderToStaticMarkup(<ColumnList columns={[primaryColumn, regularColumn]} indexes={indexes} />);
  ...
  test("renders index columns as title attribute", () => {
    const html = renderToStaticMarkup(<ColumnList columns={[primaryColumn]} indexes={indexes} />);
  ...
  test("renders composite index columns joined with comma", () => {
    const compositeIndex = [{ name: "idx_composite", columns: ["user_id", "created_at"], unique: false }];

    const html = renderToStaticMarkup(<ColumnList columns={[primaryColumn]} indexes={compositeIndex} />);
  ...
  test("renders empty state when no columns", () => {
    const html = renderToStaticMarkup(<ColumnList columns={[]} indexes={[]} />);
