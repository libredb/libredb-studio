...
# NEXT_PUBLIC_ vars are inlined at build time by Next.js — must be set here
ARG NEXT_PUBLIC_AUTH_PROVIDER_BUILD="local"
ENV JWT_SECRET=$JWT_SECRET_BUILD
ENV ADMIN_PASSWORD=$ADMIN_PASSWORD_BUILD
ENV USER_PASSWORD=$USER_PASSWORD_BUILD
ENV NEXT_PUBLIC_AUTH_PROVIDER=$NEXT_PUBLIC_AUTH_PROVIDER_BUILD
