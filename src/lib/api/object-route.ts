 ...
 *
 * There are THREE producers of `edit`: `providers/sql/postgres.ts:3120`, gated on
 * `kindAcceptsSourceEdits(capabilities, kind)`; `providers/sql/trino/index.ts:1257` and
 * `providers/keyvalue/redis.ts:1767`, both gated on `spec.acceptsSourceEdits === true`, which is the
 ...
 * stated at `redis.ts:1760-1766`: the affordance is offered on a truncated part deliberately, because
 ...
 * than it inside `buildObjectEdit`: `providers/sql/postgres.ts:3277`, `providers/keyvalue/redis.ts:1863`
