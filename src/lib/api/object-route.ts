 ...
 *
 * There are THREE producers of `edit`: `providers/sql/postgres.ts:3146`, gated on
 * `kindAcceptsSourceEdits(capabilities, kind)`; `providers/sql/trino/index.ts:1258` and
 * `providers/keyvalue/redis.ts:1781`, both gated on `spec.acceptsSourceEdits === true`, which is the
 ...
 * stated at `redis.ts:1774-1780`: the affordance is offered on a truncated part deliberately, because
 ...
 * than it inside `buildObjectEdit`: `providers/sql/postgres.ts:3303`, `providers/keyvalue/redis.ts:1871`
 * and `providers/sql/trino/index.ts:1452`. The second is what closes the class rather than narrowing
