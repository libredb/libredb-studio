 ...
 *
 * There are THREE producers of `edit`: `providers/sql/postgres.ts:3210`, gated on
 * `kindAcceptsSourceEdits(capabilities, kind)`; `providers/sql/trino/index.ts:1279` and
 * `providers/keyvalue/redis.ts:1956`, both gated on `spec.acceptsSourceEdits === true`, which is the
 ...
 * stated at `redis.ts:1949-1955`: the affordance is offered on a truncated part deliberately, because
 ...
 * than it inside `buildObjectEdit`: `providers/sql/postgres.ts:3367`, `providers/keyvalue/redis.ts:2046`
