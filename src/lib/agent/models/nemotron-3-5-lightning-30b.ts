/**
 * `nemotron-3.5-lightning:30b` — measured at the defaults, and pinned to them.
 *
 * 3 of 6 modes locked, 26 of 30 runs passed.
 *
 *     Investigate 4/5 · Optimize 5/5 · Assess 4/5 · Operate 5/5 · Analyze 5/5 · Plan 3/5
 *
 * Still open: Investigate, Assess, Plan.
 *
...
export const NEMOTRON_3_5_LIGHTNING_30B: AgentModelProfile = {
  measured:
    "3/6 modes locked, 26/30 runs passed at these settings. Investigate 4/5 · Optimize 5/5 · Assess 4/5 · Operate 5/5 · Analyze 5/5 · Plan 3/5.",
