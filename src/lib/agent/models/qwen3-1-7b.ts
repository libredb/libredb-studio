/**
 * `qwen3:1.7b` — measured at the defaults, and pinned to them.
 *
 * 2 of 6 modes locked, 13 of 30 runs passed.
 *
 *     Investigate 0/5 · Optimize 0/5 · Assess 5/5 · Operate 3/5 · Analyze 0/5 · Plan 5/5
 *
 * Still open: Investigate, Optimize, Operate, Analyze.
 *
...
export const QWEN3_1_7B: AgentModelProfile = {
  measured:
    "2/6 modes locked, 13/30 runs passed at these settings. Investigate 0/5 · Optimize 0/5 · Assess 5/5 · Operate 3/5 · Analyze 0/5 · Plan 5/5.",
