/**
 * `qwen3:14b` — measured at the defaults, and pinned to them.
 *
 * 5 of 6 modes locked, 29 of 30 runs passed.
 *
 *     Investigate 5/5 · Optimize 5/5 · Assess 5/5 · Operate 5/5 · Analyze 5/5 · Plan 4/5
 *
 * Still open: Plan.
 *
...
export const QWEN3_14B: AgentModelProfile = {
  measured:
    "5/6 modes locked, 29/30 runs passed at these settings. Investigate 5/5 · Optimize 5/5 · Assess 5/5 · Operate 5/5 · Analyze 5/5 · Plan 4/5.",
