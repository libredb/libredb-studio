/**
 * `deepseek-r1:32b` — measured at the defaults, and pinned to them.
 *
 * 1 of 6 modes locked, 14 of 30 runs passed.
 *
 *     Investigate 2/5 · Optimize 0/5 · Assess 4/5 · Operate 2/5 · Analyze 1/5 · Plan 5/5
 *
...
export const DEEPSEEK_R1_32B: AgentModelProfile = {
  measured:
    "1/6 modes locked, 14/30 runs passed at these settings. Investigate 2/5 · Optimize 0/5 · Assess 4/5 · Operate 2/5 · Analyze 1/5 · Plan 5/5.",
