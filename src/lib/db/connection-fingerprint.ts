 ...
 * (`src/lib/db/factory.ts:574`) tests exactly that flag: a switched-off tunnel is not a route at
 ...
 *   (`src/lib/db/factory.ts:574-581`) REWRITES `host` and `port` to the tunnel's local endpoint
