 ...
 * (`src/lib/db/factory.ts:577`) tests exactly that flag: a switched-off tunnel is not a route at
 ...
 *   (`src/lib/db/factory.ts:577-584`) REWRITES `host` and `port` to the tunnel's local endpoint
