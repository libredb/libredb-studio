    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-white/5 flex items-center justify-around px-4 z-50">
      ...
      {onOpenAgent !== undefined && (
        <button
          ...
          onClick={onOpenAgent}
          className="flex flex-col items-center gap-1 transition-all duration-200 relative text-zinc-500"
        >
          <div className="p-2 rounded-xl transition-all hover:bg-white/5">
