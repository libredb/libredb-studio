 ...
 * a document connection; without this arm a Source tab on MongoDB, Redis, Prometheus or Kafka
 * would take the document icon and be indistinguishable from a query tab in the one place a reader
