    ...
    <div className="h-full flex flex-col bg-[#080808]">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-white/5 bg-[#0a0a0a]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-cyan-400">AI Performance Autopilot</span>
        </div>
        <button
      ...
      <div ref={reportRef} className="flex-1 overflow-auto p-4">
        ...
        {report && <div className="prose prose-invert prose-xs max-w-none">{renderMarkdown(report)}</div>}
      </div>
    </div>
  );
}
