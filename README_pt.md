...
> Este README em português é uma tradução da comunidade e pode estar atrás da versão em inglês. Se houver divergência, vale a [versão em inglês](README.md).
...
### Dezessete motores, uma única interface
