...
<!-- limit:256 -->
Open-source, self-hosted SQL IDE for seventeen engines: PostgreSQL, MySQL, SQL Server, Oracle, SQLite, libSQL, DuckDB, MongoDB, Redis, Couchbase, ClickHouse, Druid, Elasticsearch, OpenSearch, Trino, Cassandra and Prometheus, with read-only AI.
