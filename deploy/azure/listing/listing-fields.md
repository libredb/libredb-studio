...
<!-- limit:100 -->
Open-source SQL IDE for 18 engines: PostgreSQL, MySQL, SQL Server, Oracle, MongoDB, Redis and more

**Short description** (limit 256):

<!-- limit:256 -->
Open-source, self-hosted SQL IDE for eighteen engines: PostgreSQL, MySQL, SQL Server, Oracle, SQLite, libSQL, DuckDB, MongoDB, Redis, Couchbase, ClickHouse, Druid, Elasticsearch, OpenSearch, Trino, Cassandra, Prometheus and Kafka, with read-only AI.
...
4. `connection-modal`: "Connect to eighteen engines, from PostgreSQL and SQL Server to Apache Cassandra."
