...
- **Fifteen engines, one interface**: PostgreSQL, MySQL, Oracle, SQL Server, SQLite, libSQL, MongoDB, Redis, Couchbase, ClickHouse, Druid, Elasticsearch, OpenSearch, Trino, Cassandra.
...
<p align="center">
  ...
  <br/><em>Connect to PostgreSQL, MySQL, Oracle, SQL Server, MongoDB, Couchbase, ClickHouse, Druid, Elasticsearch, OpenSearch, Trino, Cassandra, Redis, SQLite, or libSQL with SSL/TLS and SSH Tunnel support.</em>
</p>
...
| **Database** | PostgreSQL, MySQL, Oracle, SQL Server, SQLite, libSQL, MongoDB, Couchbase, ClickHouse, Apache Druid, Elasticsearch, OpenSearch, Apache Trino, Redis | Web, Mobile |
...
```
  ...
  - A target database to query (PostgreSQL, MySQL, Oracle, SQL Server, SQLite, libSQL, MongoDB, Couchbase, ClickHouse, Apache Druid, Elasticsearch, OpenSearch, Apache Trino, or Redis)
