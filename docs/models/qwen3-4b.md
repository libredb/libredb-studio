...
The smallest model of the ten and not the fastest: its median run is longer than every other local model's here. Size buys memory, not speed, on this workload.
